    ...
    <ul class="pagination justify-content-center">
      <c:if test="${currentPage != 1}">
        <li class="page-item"><a style=" color: black;" class="page-link"
                                 href="controller?action=myIncomingsPage&page=${currentPage - 1}"><fmt:message
        ...
        <tr>
          <c:forEach begin="1" end="${noOfPages}" var="i">
            <c:choose>
              ...
              <c:otherwise>
                <li class="page-item"><a style=" color: black;" class="page-link"
                                         href="controller?action=myIncomingsPage&page=${i}">${i}</a></li>
              </c:otherwise>
            </c:choose>
          </c:forEach>
        </tr>
      ...
      <c:if test="${currentPage lt noOfPages}">
        <li class="page-item">
          <a style=" color: black;" class="page-link"
             href="controller?action=myIncomingsPage&page=${currentPage + 1}"><fmt:message key="pagination.next"
                                                                                        bundle="${lang}"/></a>
        </li>
      </c:if>
