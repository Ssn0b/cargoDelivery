    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="controller?action=home" class="nav-link px-2 text-white"><fmt:message key="header.home"
                                                                                                   bundle="${lang}"/></a>
                </li>
                <li><a href="controller?action=pricePage" class="nav-link px-2 text-white"><fmt:message
                        key="header.countPrice" bundle="${lang}"/></a></li>
                <%if (userSession != null) {%>
                <li><a href="controller?action=profilePage" class="nav-link px-2 text-white"><fmt:message
                        key="header.myProfile" bundle="${lang}"/></a></li>
                <%}%>
            </ul>
            ...
            <div class="text-end" style="margin-left: 300px">
                ...
                <a href="controller?action=registerpage" style="margin-right: 10px;">
                    <button type="button" class="btn btn-outline-light me-2"><fmt:message key="header.sign-up"
                                                                                          bundle="${lang}"/></button>
                </a>
